...
/**
 * Created by Skywevas Technologies on 17/05/17.
 * This class is makiing api call for get Guidelines list webservice
 */


public class WSGetProductData extends WSUtil
{
    ...
    public WSGetProductData(final Context context) {
        super(context);
    ...
    public ArrayList<ProductModel> executeService(Context context, final Bundle bundle) {
        ...
        this.context = context;
        return parseResponse(GET(buildURL(WsConstants.METHOD_PRODUCT_LIST, bundle).toString()));
    }
